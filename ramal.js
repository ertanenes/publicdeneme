...
client.on("userUpdate", async (o, n) => {
	...
	const member = client.guilds.cache.get("1043891010687729755").members.cache.get(o.id)
	...
	const taglog = client.guilds.cache.get("1043891010687729755").channels.cache.get(data.tagLog)
	const aktiftaglı = client.guilds.cache.get("1043891010687729755").members.cache.filter(gloxy => tags.some(x => gloxy.user.tag.includes(x))).size
