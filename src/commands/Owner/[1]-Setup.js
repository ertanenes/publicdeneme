...
message.channel.send({embeds: [embedm.setDescription(`Kurulum mnüsüne hoş geldiniz! Aşağıda ki butonları kullanarak Kurulum hakkında bilgi alabilir, veya kurulum yapmış olduğunuz setup bilgilerine erişebilirsiniz!\n\n• NOT: **Kurulumu tamamlamadan komutları kullanmayınız.**`)], components: [buttons]})
}
